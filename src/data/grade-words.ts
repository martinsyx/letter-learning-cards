...
export type GradeWords = Record<string, Array<{ word: string; phonetic: string; icon: string }>>

// ============================================================
// 沪教牛津版 (Shanghai Oxford) — 5 个年级
// ============================================================

export const oxfordGrade1Words: GradeWords = {
  A: [
...
export const oxfordGrade2Words: GradeWords = {
  A: [
...
export const oxfordGrade3Words: GradeWords = {
  A: [
...
export const oxfordGrade4Words: GradeWords = {
  A: [
...
export const oxfordGrade5Words: GradeWords = {
  A: [
...
export const hujiaoGrade1Words: GradeWords = {
...
export const hujiaoGrade2Words: GradeWords = {
...
export const hujiaoGrade3Words: GradeWords = {
  A: [
...
export const hujiaoGrade4Words: GradeWords = {
  A: [
    { word: "afternoon", phonetic: "/ˌæf.tərˈnuːn/", icon: "🌅" },
...
export const hujiaoGrade5Words: GradeWords = {
  A: [
    { word: "afternoon", phonetic: "/ˌæf.tərˈnuːn/", icon: "🌅" },
...
export const hujiaoGrade6Words: GradeWords = {
  A: [
...
export const oxfordGradeData: Record<number, GradeWords> = {
  1: oxfordGrade1Words,
  2: oxfordGrade2Words,
  3: oxfordGrade3Words,
  4: oxfordGrade4Words,
...
export const hujiaoGradeData: Record<number, GradeWords> = {
  1: hujiaoGrade1Words,
  2: hujiaoGrade2Words,
  3: hujiaoGrade3Words,
  4: hujiaoGrade4Words,
